...
`;
  ...
  const autoRead = {
    ...
    beginScroll() {
      ...
      const scrollStep = pace.getScrollStep(appState.currentScrollSpeed);
    ...
    startTimer() {
      ...
      appState.timerInterval = setInterval(() => {
        ...
        if (appState.remainingTime <= 0) {
          if (moduleRegistry.voiceRead) {
            moduleRegistry.voiceRead.stop({ silent: true });
          } else {
            this.stop();
          }
          utils.notificationManager.show("定时时间到，语音阅读已停止");
        }
      }, 1e3);
    },
    stopTimer() {
  ...
  const controlPanel = {
    init() {
      ...
      <div class="control-panel" style="display: none;" id="mainControlPanel">
        ...
        <div class="control-section">
          <div class="control-section-title">语音阅读</div>
          <div class="control-buttons">
          ...
          <label class="control-checkbox">
            <input type="checkbox" id="ttsFollowCheckbox" checked>
            章节续读
          </label>

...
`;
  ...
  const autoRead = {
    ...
    updateLastTimerButton() {
      $("#lastTimerBtn, #autoLastTimerBtn").each(function updateLastTimer() {
        ...
        $(this).toggleClass("disabled", disabled).css("background", "");
      });
    },
    applyLastTimer() {
  ...
  const controlPanel = {
    init() {
      ...
      $("body").append(`
      <div class="control-panel" style="display: none; width: ${savedPanelWidth}px;" id="mainControlPanel">
    ...
    bindEvents() {
      ...
      $("#controlPanelResizer").on("mousedown", function handlePanelResize(event) {
        ...
        function resizePanel(moveEvent) {
          const nextWidth = Math.max(260, Math.min(
      ...
      $("#timerSlider").on("input", function handleTimerInput() {
        moduleRegistry.autoRead?.setTimerMinutes($(this).val());
      });
